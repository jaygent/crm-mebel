    ...
    <div class="container-fluid">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <form action="/manager/add/<?echo $idmaster; ?>" method="post">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <select name="dispetcher" ><?php foreach($master as $m){if($m['id_master']==$_SESSION['id']){echo '<option value="'.$_SESSION['id'].'">'.$m['name'].'</option>';}} ?></select>
                            </div>
                            </div>
