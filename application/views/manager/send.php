                        ...
                        <form action="<? echo $_SERVER['REQUEST_URI']; ?>" method="post">
                            <div class="form">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="number[]"  placeholder="892600" value="" minlength="8"  maxlength="14" required>
                                </div></div>
    ...
    $('#addbtn').click(function () {
        ...
        if(inpputf<5){
            $( ".form" ).append('<div class="form-group">\n' +
                '                                <label>Номер телефона</label>\n' +
                '                                <input type="number" class="form-control" name="number[]"  value="" minlength="8"  placeholder="89152655400" maxlength="14" required>\n' +
                '                            </div>');
