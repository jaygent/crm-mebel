...
<div class="content-wrapper">
    <div class="container-fluid">
        <div class="card mb-3">
            <div class="card-header">Заказы в работе Журнал <?if(!empty($idmaster)){ foreach ($master as $val) {
                    ...
                    <div class="col-sm-12">
                        ...
                        if(!empty($maste)){
                            foreach ($maste as $val) {
                                if($val['proff']==='мастер'){
                                    echo $val['name'].'<a class="btn bg-danger" href="/manger/works/'.$val['id_master'].'" style="border: 2px solid #fff; color: #fff;">В работе</a><a class="btn bg-warning" href="/manager/nooplata/'.$val['id_master'].'" style="border: 2px solid #fff; color: #fff;">Готов-Не оплачен</a>';
                                }
                            }}?>
                        ...
                        <?php else: ?>
                            <table class="table delivery">
                                ...
                                ?> >
                                    ...
                                    echo '<td aria-label="Данные Клиента">'.$value['klient'].'</td>';
