<div class="content-wrapper">
    <div class="container-fluid">
        <div class="card mb-3">
            <div class="card-header">Расходник <a class="btn btn-primary" href="/manager/rasxodadd">Добавить рассходник</a></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="kalendar">
                        ...
                        <form action="/manager/rasxod" method="post" style="display: none;">
