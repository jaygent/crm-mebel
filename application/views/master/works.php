                    ...
                    <div class="col-sm-12">
                        ...
                        if(!empty($maste)){
                            foreach ($maste as $val) {
                                if($val['proff']==='мастер'){
                                    echo $val['name'].'<a class="btn bg-danger" href="/manger/works/'.$val['id_master'].'" style="border: 2px solid #fff; color: #fff;">В работе</a><a class="btn bg-warning" href="/master/nooplata/'.$val['id_master'].'" style="border: 2px solid #fff; color: #fff;">Готов-Не оплачен</a>';
                                }
                            }}?>
