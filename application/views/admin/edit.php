    ...
    <div class="container-fluid">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <form action="/admin/edit/<? echo $idmaster; ?>/<?php echo $data[0]['id_zakaza']; ?>" method="post" >
                            ...
                            if(!empty($data[0]['mastersplitup'])){
                                $selectob1='';$selectob2='';$selectsh1='';$selectsh2='';
                                foreach ($data[0]['mastersplitup'] as $splitup){
                                    if($splitup['part']==1){$price1=$splitup['prices'];}else{$price2=$splitup['prices'];}
                            ...
                            <div id="splitup" style="margin: 50px auto; font-size: 20px;width: 50%; text-align: center;">
                                ...
                                <a href="/admin/posts/<? echo $idmaster; ?>" class="btn btn-primary btn-block">Назад</a>
                        </form>
                    </div>
                </div>
            </div>
