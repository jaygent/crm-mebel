<div class="content-wrapper">
    <div class="container-fluid">
        <div class="card mb-3">
            <div class="card-header">Расходник <a class="btn btn-primary" href="/admin/rasxodadd">Добавить рассходник</a></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="kalendar">
                        ...
                        <form action="/admin/rasxod" method="post" style="display: none;">
